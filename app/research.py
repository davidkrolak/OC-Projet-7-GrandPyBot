...
class Research:
    ...
    def __init__(self, user_input):
        ...
        self.stop_words = ["a", "à", "abord", "absolument", "afin", "ah", "ai",
                           "aie",
                           "ailleurs",
                           "ainsi", "ait", "allaient", "allo", "allons", "allô",
                           "alors",
                           ...
                           "eux-mêmes",
                           "exactement", "excepté", "extenso", "exterieur", "f",
                           "fais",
                           ...
                           "hélas", "i",
                           "il", "ils", "importe", "j", "je", "jusqu", "jusque",
                           "juste",
                           ...
                           "nous",
                           "nous-mêmes", "nouveau", "nul", "néanmoins", "nôtre",
                           "nôtres",
                           "o", "oh", "ohé", "ollé", "olé", "on", "ont", "onze",
                           "onzième",
                           ...
                           "proche", "près",
                           "psitt", "pu", "puis", "puisque", "pur", "pure", "q",
                           "qu",
    ...
    def _google_api_request(self):
        ...
        response_dict["formatted_address"] = google_places_data[
            "formatted_address"]
        response_dict["lat"] = google_places_data["geometry"]["location"][
            "lat"]
        response_dict["lng"] = google_places_data["geometry"]["location"][
            "lng"]

    def _wikimedia_api_request(self):
    ...
    def _grandpy_response(self):
        ...
        if response_dict["status"] == "zero_results":
            response = random.choice(self.zero_results_responses)
            response_dict["grandpy_response"] = response
        elif response_dict["status"] == "error":
